...
class gynecologiqueedit extends StatefulWidget {
  final String patientId; // Declare the patientId variable as a parameter

  gynecologiqueedit({required this.patientId}); 
  @override
  int? gpcaSelection;
  ...
  State<gynecologiqueedit> createState() => _gynecologiqueeditState();
}
...
class _gynecologiqueeditState extends State<gynecologiqueedit> {
