...
class ExamenGynecologique extends StatefulWidget {
  @override
  _ExamenGynecologiqueState createState() => _ExamenGynecologiqueState();
}

class _ExamenGynecologiqueState extends State<ExamenGynecologique> {
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelStyle: TextStyle(color: Color(0xFF4F3981)),
                  ),
                  validator: (value) {
                    if (value == null) {
