...
class _HomeScreenState extends State<HomeScreen>
  ...
  crossAxisSpacing: 30,
  children: [
    itemDashboard('Examen obstétricale n', 'images/enceinte.svg', Colors.deepPurple, 'exam'),
    itemDashboard('Examen obstétricale a', 'images/mere.svg', Colors.deepPurple, 'exam2'),
    itemDashboard('Examen gyneco a', 'images/gyneco.svg', Colors.deepPurple, 'table'),
    itemDashboard('Examen gyneco n ', 'images/visite.svg', Colors.deepPurple, 'table'),
